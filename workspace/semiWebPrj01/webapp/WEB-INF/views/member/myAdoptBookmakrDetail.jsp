    ...
    <div class="container post">
        <div class="row">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <svg class="bd-placeholder-img" width="100%" height="650px" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" viewBox="0 0 2560 1600">
                            <image href="/YW_images/화보고양이.jpg" width="100%" height="100%"></image>
                        </svg>
                    ...
                    <div class="carousel-item active">
                        <svg class="bd-placeholder-img" width="100%" height="650px" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" viewBox="0 0 2560 1600">
                            <image href="/YW_images/혓바닥고양이.jpg" width="100%" height="100%"></image>
                        </svg>

                    </div>
                    <div class="carousel-item">
                        <svg class="bd-placeholder-img" width="100%" height="650px" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" viewBox="0 0 2560 1600">
                            <image href="/YW_images/쳐다보는 고등어태비.jpg" width="100%" height="100%"></image>
                        </svg>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-primary adopt-btn">입양하기</button>
                    </div>
                </div>
